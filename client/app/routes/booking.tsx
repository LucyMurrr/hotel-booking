...
//   const initialCheckIn = searchParams.get('checkIn');
//   const initialCheckOut = searchParams.get('checkOut');
//   const roomId = Number(location.pathname.split('/')[2]);
...
// Установка выбранных дат в начальное состояние, если они есть
// useEffect(() => {
//   if (initialCheckIn && initialCheckOut) {
//     const start = dayjs(initialCheckIn);
//     const end = dayjs(initialCheckOut);
...
//               style={{ marginBottom: 24 }}
//             />
//             <Button type="primary" onClick={handleSubmit} block loading={loading} size="large">
//               Подтвердить бронирование
//             </Button>
//           </div>
//         )}
